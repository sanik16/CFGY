...
//Functions button
		...
		btnVytvorUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					String query = "insert into profil(weight, heigh, bench, back, front, clean, snatch, pull) values (?, ?, ?, ?, ?, ?, ?, ?) where id_user = '"+lblIdUser.getText()+"' "; 
		...
		btnHistorySHop2015.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					String query = "select  avg(cena) from users u join objednavka o on u.id_user = o.id_user join polozka p on o.id_objednavka = p.id_objednavka join produkt pr on p.id_produkt = pr.id_produkt where extract(year from datum_objednavky) = 2015"; 
		...
		btnCrossfit_prihlas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					String query = "insert treningy (id_typ_treningu, pocet_cvicencov, pocet_akt) values (1, 20, 12)"; 
